...
public class ProfesorResource {
    ...
    public Response putProfesor(@Context HttpHeaders herders, byte[] in) {
        ...
        Profesor p = new Profesor(params.get("id"), params.get("cedula"), params.get("nombre"), params.get("titulo"), params.get("area"), params.get("correo"), params.get("telefono"), new ArrayList<Grupo>());
        return putAndGetResponse(p);
    }
